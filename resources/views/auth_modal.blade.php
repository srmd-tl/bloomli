...
<head>
  ...
  <link rel="stylesheet" href="{{asset('auth_modal_assets/css/bootstrap.min.css')}}" />
  <!-- Main Stylesheet -->
  <link rel="stylesheet" href="{{asset('auth_modal_assets/css/style.css')}}" />
  <!-- Responsive Stylesheet -->
  <link rel="stylesheet" href="{{asset('auth_modal_assets/css/responsive.css')}}" />
</head>
<body>
  <!-- Modal start here -->
          ...
          <div class="bloomli-modal bg-primary w-100 position-relative">
            ...
            <div class="bloomli-header">
              <div class="close-modal position-relative">
                <span data-bs-dismiss="modal" aria-label="Close"><img class="img-fluid" src="auth_modal_assets/images/icons/close.png" alt="close" /></span>
              </div>
                  ...
                  <div class="bloomli-login-section p-77">
                    ...
                    <form action="{{route('login')}}" method="POST">
                      ...
                      <div class="form-list">
                        ...
                        <span id="pass-show"><img src="auth_modal_assets/images/icons/passcode.png" alt="show passcode" /></span>
                      </div>
                      ...
                      <div class="form-list text-center">
                        ...
                        <a href="{{route('auth.google')}}" class="btn btn-google"><img src="auth_modal_assets/images/icons/google.png" alt="google" /> Google</a>
                      </div>
                    </form>
                  </div>
                  <!-- login section ends  -->
                      ...
                      <div class="accordion" id="bloomli-accordion">
                        <div class="accordion-item">
                          <h2 class="accordion-header" id="headingOne">
                            ...
                            <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#account-creation" aria-expanded="true" aria-controls="account-creation">Create Your Account <span><img src="auth_modal_assets/images/icons/edit.png" alt="edit"></span></button>
                          </h2>                          
                            ...
                            <div class="accordion-body">
                              <div class="gift-box text-center">
                                ...
                                <ul class="gift-listing">
                                  <li>
                                    <div class="gift-icon">
                                      <img src="auth_modal_assets/images/icons/book-and-pencil.png" alt="taking notes" />
                                    </div>
                                    <span>Taking Notes</span>
                                  </li>
                                  <li>
                                    <div class="gift-icon">
                                      <img src="auth_modal_assets/images/icons/quiz.png" alt="quiz" />
                                    </div>
                                    <span>Avatar Quiz</span>
                                  </li>
                                  <li>
                                    <div class="gift-icon">
                                      <img src="auth_modal_assets/images/icons/insights.png" alt="insights" />
                                    </div>
                                    <span>Key Insights</span>
                                  </li>
                                  <li>
                                    <div class="gift-icon">
                                      <img src="auth_modal_assets/images/icons/more.png" alt="more" />
                                    </div>
                                    <span>More</span>
                                  </li>
                                </ul>
                              ...
                              <div class="write-info">
                                ...
                                <div class="form-list">
                                  <input 
                                    ...
                                    data-bs-target="#choose-plan"
                                    aria-expanded="false"
                                    aria-controls="choose-plan"
                        ...
                        <div class="accordion-item">
                          <h2 class="accordion-header" id="headingTwo">
                            ...
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#choose-plan" aria-expanded="false" aria-controls="choose-plan">Choose Your Plan  <span><img src="auth_modal_assets/images/icons/edit.png" alt="edit"></span></button>
                          </h2>
                            ...
                            <div class="accordion-body">
                              ...
                              <div class="choose-plan">
                                ...
                                <div class="plan-item">
                                  <div class="plan-radio">
                                    <div class="form-check">
                                      <input class="form-check-input" type="radio" name="choose_plan"
                                      value="0"
                                      />
                                    </div>
                                  </div>
                                ...
                                <div class="plan-item">
                                  ...
                                  <span> <img src="auth_modal_assets/images/icons/check.png" alt="check" /> 7 Days free trial</span>
                                </div>
                                <!-- plan free ends -->
                                <!-- plan free start -->
                                <div class="plan-item">
                        ...
                        <div class="accordion-item">
                          <h2 class="accordion-header" id="headingThree">
                            ...
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#payment-detail" aria-expanded="false" aria-controls="payment-detail">Add Your Payment Details  <span><img src="auth_modal_assets/images/icons/edit.png" alt="edit"></span></button>
                          </h2>
                            ...
                            <div class="accordion-body">
                              ...
                              <div class="payment-detail">
                                <div class="form-list">
                                  ...
                                  <span><img src="auth_modal_assets/images/icons/card.png" alt="card number" /></span>
                                </div>
                                ...
                                <div class="form-list">
                                  ...
                                  type="button"
                                  class="btn btn-submit"
                                  data-bs-toggle="collapse" data-bs-target="#payment-summary" aria-expanded="false" aria-controls="payment-summary"  
                                  value="Save Card and Continue" />
                                </div>
                                <div class="form-list text-center">
                                  <div class="another-way d-flex align-items-center justify-content-center">
                                    <span></span>
                                  ...
                                  <button type="button" class="btn btn-google w-100"><img src="auth_modal_assets/images/icons/paypal.png" alt="paypal" /> Check out with PayPal</button>
                                </div>
                              </div>
                              <!-- payment detail ends-->
                            </div>
                        ...
                        <div class="accordion-item">
                          <h2 class="accordion-header" id="headingThree">
                            ...
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#payment-summary" aria-expanded="false" aria-controls="payment-summary">Payment Summary  <span><img src="auth_modal_assets/images/icons/edit.png" alt="edit"></span></button>
                          </h2>
                            ...
                            <div class="accordion-body">
                              <div class="payment-summary">
                                ...
                                <div class="payment-card d-flex align-items-center">
                                  <img src="auth_modal_assets/images/icons/master.png" alt="card name" />
                                  <p>**** 1234 04/21</p>
                                </div>
                                <div class="terms">
  ...
  <!-- Jquery Js -->
  <script src="{{asset('auth_modal_assets/js/jquery.min.js')}}"></script>
  <!-- Popper Js -->
  <script src="{{asset('auth_modal_assets/js/popper.min.js')}}"></script>
  <!-- Bootstrap Js -->
  <script src="{{asset('auth_modal_assets/js/bootstrap.min.js')}}"></script>
  <!-- jQuery Steps Js -->
  <script src="{{asset('auth_modal_assets/js/jquery.steps.min.js')}}"></script>
  <!-- Main Js -->
  <script src="{{asset('auth_modal_assets/js/main.js')}}'"></script>
</body>
</html>
