                        ...
                        <div class="block-element2">
                            ...
                            <div class="block-element2">
                                <div class="form-field2">
                                    ...
                                    <select class="field-style2" name="category" required>
                                ...
                                <div class="form-field2 image-uploader-wrap">
                                    ...
                                    <input type="file" id="file-1" accept=".jpg,.jpeg,.png,.svg" name="cover"/>
                                    <label for="file-1"> <i class="fa fa-plus"> </i> choose a file</label>
                                </div>

                                <div class="form-field2 image-uploader-wrap">
                                    <label> Upload PDF: </label>
                                    <input type="file" id="file-2" accept=".pdf" name="pdf"/>
                                    <label for="file-2"> <i class="fa fa-plus"> </i> choose a file</label>
                                </div>

                                <div class="form-field2 image-uploader-wrap">
                                    <label> Upload Audio: </label>
                                    <input type="file" id="file-3" accept=".mp3" name="audio"/>
                                    <label for="file-3"> <i class="fa fa-plus"> </i> choose a file</label>
                                </div>

                                <div class="form-field3">
                                    <label> Description: </label>
                                    <textarea class="field-style3" name="description" required></textarea>
                                </div>
